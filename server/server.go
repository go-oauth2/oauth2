...
func (s *Server) redirect(w http.ResponseWriter, req *AuthorizeRequest, data map[string]any) error {
...
func (s *Server) GetAuthorizeData(rt oauth2.ResponseType, ti oauth2.TokenInfo) map[string]any {
	if rt == oauth2.Code {
...
func (s *Server) GetTokenData(ti oauth2.TokenInfo) map[string]any {
	data := map[string]any{
