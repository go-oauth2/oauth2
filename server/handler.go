...
type (
	...
	ExtensionFieldsHandler func(ti oauth2.TokenInfo) (fieldsValue map[string]any)

	// ResponseTokenHandler response token handling
	ResponseTokenHandler func(w http.ResponseWriter, data map[string]any, header http.Header, statusCode ...int) error
